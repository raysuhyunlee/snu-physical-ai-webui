...
export const verifyConfigUrl = async (token: string = '') => {
	...
	const res = await fetch(`${MUSIC_API_BASE_URL}/config/url/verify`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getMusicGenerationModels = async (token: string = '') => {
	let error = null;

	const res = await fetch(`${MUSIC_API_BASE_URL}/models`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const musicGenerations = async (
	token: string = '',
	prompt: string,
	lyrics?: string,
	model?: string
	...
	const res = await fetch(`${MUSIC_API_BASE_URL}/generations`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
